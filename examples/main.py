...
def home():
    ...
    jp.Div(a=div2, text="Im a cool interactive div!", classes="hover:bg-red-500", mouseenter=mouse_enter,
           mouseleave=mouse_left)
    return wp


def sum_up(widget, msg):
    print(widget.in1.value, type(widget.in2.value))
...
def mouse_enter(widget, msg):
    widget.text = "A mouse enter the house"
